...
a_x = 3   #aceleração constante 

#para obter a posição a partir da acelreração integramos duas vezes 
...
x_values = [((1/2) * t**2) for t in t_values]  # Avaliar x(t) = 1.5 * t^2  (equação do movimento com posição inicial 0  e velocidade inicial 0)
